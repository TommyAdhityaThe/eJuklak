...
/**
 * Adapter implemented for ExpandableListView in navigation drawer
 * @author ftis unpar
...
public class ExpandableAdapter extends BaseExpandableListAdapter {
	...
	/**
	 * List of DrawerItem for navigation drawer
	 */
	ArrayList<DrawerItem> al;
	
	/**
	 * Constructor ExpandableAdapter
	 * @param c Active Activity 
	 * @param al Navigation Drawer list
	 */
